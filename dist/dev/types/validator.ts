...
// Validate ../../../src/app/api/user/customizeData/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user/customizeData">> = Specific
  const handler = {} as typeof import("../../../src/app/api/user/customizeData/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
